...
bcftools view -S aou-sas-sample-list.txt --force-samples \
  ...
  acaf_threshold_unrelated.chr1.biallelic.phased.vcf.gz
...
#####################
# Set variables 
VCF_FILE="acaf_threshold_unrelated_AMR.chr1.biallelic.phased.vcf.gz"
CHUNK_SIZE=10000
...
#####################
# Set variables 
VCF_FILE="acaf_threshold_unrelated_AFR.chr1.biallelic.phased.vcf.gz"
CHUNK_SIZE=10000
...
JAVA_OPTS="-Xmx500g"
FLARE_JAR="flare.jar"
INPUT_VCF="acaf_threshold_unrelated_SAS.chr1.biallelic.phased.vcf.gz"
REF_VCF_FILE="hgdp-1kgp-ref_chr1_biallelic.phased.add_chr.vcf.gz"
REF_PANEL="ucsd-ref.panel"
MAP_FILE="plink.chr1.GRCh38.map"
OUTPUT_PREFIX="flare_output.six-ancestry-acaf-unrelated-SAS.chr1"
...
bcftools index --tbi flare_output.six-ancestry-acaf-unrelated-SAS.chr1.anc.vcf.gz
##############################
...
JAVA_OPTS="-Xmx500g"
FLARE_JAR="flare.jar"
INPUT_VCF="acaf_threshold_unrelated_EAS.chr1.biallelic.phased.vcf.gz"
REF_VCF_FILE="hgdp-1kgp-ref_chr1_biallelic.phased.add_chr.vcf.gz"
REF_PANEL="ucsd-ref.panel"
MAP_FILE="plink.chr1.GRCh38.map"
OUTPUT_PREFIX="flare_output.six-ancestry-acaf-unrelated-EAS.chr1"
...
bcftools index --tbi flare_output.six-ancestry-acaf-unrelated-EAS.chr1.anc.vcf.gz
##############################

# Set parameters
JAVA_OPTS="-Xmx500g"
FLARE_JAR="flare.jar"
INPUT_VCF="acaf_threshold_unrelated_MID.chr1.biallelic.phased.vcf.gz"
REF_VCF_FILE="hgdp-1kgp-ref_chr1_biallelic.phased.add_chr.vcf.gz"
REF_PANEL="ucsd-ref.panel"
MAP_FILE="plink.chr1.GRCh38.map"
OUTPUT_PREFIX="flare_output.six-ancestry-acaf-unrelated-MID.chr1"
...
REF_PANEL="ucsd-ref.panel"
MAP_FILE="plink.chr1.GRCh38.map"
OUTPUT_PREFIX="ancestry-flare-EUR-run/flare_output.six-ancestry-acaf-unrelated-EUR.chr1"
OUTPUT_DIR="ancestry-flare-EUR-run"
...
REF_PANEL="ucsd-ref.panel"
MAP_FILE="plink.chr1.GRCh38.map"
OUTPUT_PREFIX="ancestry-flare-AFR-run/flare_output.six-ancestry-acaf-unrelated-AFR.chr1"
OUTPUT_DIR="ancestry-flare-AFR-run"
...
REF_PANEL="ucsd-ref.panel"
MAP_FILE="plink.chr1.GRCh38.map"
OUTPUT_PREFIX="ancestry-flare-AMR-run/flare_output.six-ancestry-acaf-unrelated-AMR.chr1"
OUTPUT_DIR="ancestry-flare-AMR-run"
...
# Example: Local ancestry results
# flare_output.six-ancestry-acaf-unrelated-eas.chr21.global.anc.gz
# flare_output.six-ancestry-acaf-unrelated-mid.chr21.global.anc.gz
# flare_output.six-ancestry-acaf-unrelated-sas.chr21.global.anc.gz
# ancestry-flare-EUR-run/*.global.anc.gz
# ancestry-flare-AMR-run/*.global.anc.gz
# ancestry-flare-AFR-run/*.global.anc.gz

# Define output file
OUTPUT_GLOBAL="flare_output.seperated-ancestry-run-acaf-unrelated.chr1.merged.global.anc.gz"
...
FILES_TO_MERGE+=" flare_output.six-ancestry-acaf-unrelated-EAS.chr1.global.anc.gz"
FILES_TO_MERGE+=" flare_output.six-ancestry-acaf-unrelated-MID.chr1.global.anc.gz"
FILES_TO_MERGE+=" flare_output.six-ancestry-acaf-unrelated-SAS.chr1.global.anc.gz"
...
(zcat flare_output.six-ancestry-acaf-unrelated-EAS.chr1.global.anc.gz | head -n 1;
 for file in $FILES_TO_MERGE; do
     zcat "$file" | tail -n +2
 done) | gzip > "$OUTPUT_GLOBAL"

zcat flare_output.seperated-ancestry-run-acaf-unrelated.chr1.merged.global.anc.gz | \
awk 'NR==1 {print $1, $7, $3, $5, $4, $2, $6; next} {print $1, $7, $3, $5, $4, $2, $6}' OFS="\t" | \
bgzip > flare_output.seperated-ancestry-run-acaf-unrelated.chr1.merged.global.anc.tmp.gz

# Replace the original file safely
mv flare_output.seperated-ancestry-run-acaf-unrelated.chr1.merged.global.anc.tmp.gz \
   flare_output.seperated-ancestry-run-acaf-unrelated.chr1.merged.global.anc.gz
...
OUTPUT_LOG="flare_output.seperated-ancestry-run-acaf-unrelated.chr1.merged.log"
...
echo "flare_output.six-ancestry-acaf-unrelated-EAS.chr1.model" >> model_files.txt
echo "flare_output.six-ancestry-acaf-unrelated-MID.chr1.model" >> model_files.txt
echo "flare_output.six-ancestry-acaf-unrelated-SAS.chr1.model" >> model_files.txt
...
echo "flare_output.six-ancestry-acaf-unrelated-EAS.chr1.log" >> log_files.txt
echo "flare_output.six-ancestry-acaf-unrelated-MID.chr1.log" >> log_files.txt
echo "flare_output.six-ancestry-acaf-unrelated-SAS.chr1.log" >> log_files.txt
...
echo "flare_output.six-ancestry-acaf-unrelated-EAS.chr1.anc.vcf.gz" >> "$FILE_LIST"
echo "flare_output.six-ancestry-acaf-unrelated-MID.chr1.anc.vcf.gz" >> "$FILE_LIST"
echo "flare_output.six-ancestry-acaf-unrelated-SAS.chr1.anc.vcf.gz" >> "$FILE_LIST"
...
gsutil -u $GOOGLE_PROJECT cp flare_output.seperated-ancestry-run-acaf-unrelated.chr1.merged.global.anc.gz gs://fc-secure-5efb5f8d-7703-495b-8dc7-3d90605152e5/ancestry-calling/
gsutil -u $GOOGLE_PROJECT cp flare_output.seperated-ancestry-run-acaf-unrelated.chr1.merged.model gs://fc-secure-5efb5f8d-7703-495b-8dc7-3d90605152e5/ancestry-calling/
