...
def main():
    ...
    if args.method == "hail":
        ...
        runner = HailRunner(data, region=args.region, norm = args.norm, covars=covars, sample_call_rate=args.sample_call_rate, variant_call_rate=args.variant_call_rate, MAF=args.MAF, HWE=args.HWE, GQ=args.GQ)
