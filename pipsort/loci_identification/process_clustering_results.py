...
fam_with_ancestry = fam_with_ancestry[['research_id', 'label', 'ancestry_pred', 'ancestry_pred_other','pc1','pc2','pc3']]
...
plt.savefig(fileprefix+"_pcs1v2_ancestry_pred.png")
plt.clf()
sns.scatterplot(x='pc1', y='pc2', hue='ancestry_pred_other', data=fam_with_ancestry, palette='Set1')
plt.xlabel('PC1')
plt.ylabel('PC2')
plt.title('PC1 vs PC2 Colored by Ancestry')
plt.savefig(fileprefix+"_pcs1v2_ancestry_pred_other.png")
plt.clf()

sns.scatterplot(x='pc2', y='pc3', hue='ancestry_pred', data=fam_with_ancestry, palette='Set1')
plt.xlabel('PC2')
plt.ylabel('PC3')
plt.title('PC2 vs PC3 Colored by Ancestry')
plt.savefig(fileprefix+"_pcs2v3_ancestry_pred.png")
plt.clf()
sns.scatterplot(x='pc2', y='pc3', hue='ancestry_pred_other', data=fam_with_ancestry, palette='Set1')
plt.xlabel('PC2')
plt.ylabel('PC3')
plt.title('PC2 vs PC3 Colored by Ancestry')
plt.savefig(fileprefix+"_pcs2v3_ancestry_pred_other.png")
plt.clf()
