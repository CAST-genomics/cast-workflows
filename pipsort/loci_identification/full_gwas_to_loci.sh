...
python construct_loci.py --s1_signals ${phen_name}_${pop1}_peaks.csv --s2_signals ${phen_name}_${pop2}_peaks.csv --delim , --outfile ${phen_name}_1MB_loci.txt --pval_col p_value --pos_col pos --chr_col chrom --id_col rsid --chr_name_prefix chr

gsutil cp ${phen_name}_1MB_loci.txt "${WORKSPACE_BUCKET}/pipsort/loci"
