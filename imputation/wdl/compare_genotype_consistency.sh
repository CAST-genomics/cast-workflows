...
#shapeit_vcf="data/output_chr11_aou_100_phasing_shapeit_impute_beagle_apr_22_bref.vcf.gz"
#shapeit_cbl="data/CBL_aou_100_phase_shapeit_impute_beagle_apr_22_bref.vcf.gz"
shapeit_vcf="data/output_chr11_aou_100_phasing_shapeit_impute_beagle_iflag_apr_22_bref.vcf.gz"
shapeit_cbl="data/CBL_aou_100_phase_shapeit_impute_beagle_iflag_apr_22_bref.vcf.gz"
